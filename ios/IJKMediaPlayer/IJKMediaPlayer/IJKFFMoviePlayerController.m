...
void IJKFFIOSetExternalContext(int (*read_packet)(char* file_name, int64_t pos, void *buf, int buf_size),
                         int (*write_packet)(char* file_name, int64_t pos, void *buf, int buf_size),
                         int64_t (*seek)(char* file_name, int64_t pos, int64_t offset, int whence))
{
    avio_set_external(read_packet, write_packet, seek);
}
